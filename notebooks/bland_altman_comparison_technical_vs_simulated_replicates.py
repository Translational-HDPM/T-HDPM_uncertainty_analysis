...
def _(mo):
    mo.md(r"""
    ## Comparison of Simulated Replicates against Technical Replicates from Dataset
    """)
    return
...
def _(mo):
    mo.md(r"""
    The purpose of this notebook is to compare the replicates generated through Monte Carlo sampling of technical replicates for a given patient with added noise to simulate measurement uncertainty. This comparison is done through Bland-Altman charts of two replicates of the same patient taken from the original dataset, compared against two synthetic replicates generated by MC sampling.
    """)
    return
...
def _(mo):
    mo.md(r"""
    ### Generating MC sampled replicates
    """)
    return
