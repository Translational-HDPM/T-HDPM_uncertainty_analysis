...
def main():
    ...
    plot_uncert_at_thresh(
        Patients_df_zScore, coefficients, NUM_RUNS, UNCERTAINTY, THRESH
    )
    ...
    # V plot of agreement between simulated scores and original scores,
    # with LOESS
    sub_accuracy_loess_plot(
        Patients_df_zScore, coefficients, UNCERT_RANGE, THRESH, NUM_RUNS
    )
